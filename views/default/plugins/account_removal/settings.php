...
<div>
	<?php 
		...
		echo "&nbsp;" . elgg_view("input/dropdown", array("name" => "params[user_options]", "options_values" => $user_options, "value" => $plugin->user_options));
	?>
</div>
...
<div>
	<?php 
		...
		echo "&nbsp;" . elgg_view("input/dropdown", array("name" => "params[groupadmins_allowed]", "options_values" => $noyes_options, "value" => $plugin->groupadmins_allowed));
	?>
</div>
...
<div>
	<?php 
		...
		echo "&nbsp;" . elgg_view("input/dropdown", array("name" => "params[reason_required]", "options_values" => $noyes_options, "value" => $plugin->reason_required));
	?>
</div>